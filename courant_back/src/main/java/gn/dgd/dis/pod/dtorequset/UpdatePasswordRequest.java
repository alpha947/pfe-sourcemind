...
public class UpdatePasswordRequest {
    ...
    @NotEmpty(message = "Le nouveau mot de passe ne doit pas etre vide ou nul")
    private String newPassword;
    @NotEmpty(message = "La confirmation du nouveau mot de passe ne doit pas etre vide ou nul")
