                    ...
                    <div className="card-body">
                      <form onSubmit={handleSubmit(onUpdateDocument)} className="needs-validation" noValidate>
                        ...
                        <div className="row g-3">
                          ...
                          <div className="col-sm-6">
                            <label htmlFor="firstName" className="form-label">Date d'annonce de l'acte</label><div className="input-group has-validation">
                              <span className="input-group-text"><i className="bi bi-calendar"></i></span>
                              <input type="text" {...register('createdAt')} defaultValue={new Intl.DateTimeFormat('fr-fr', { weekday: 'long', year: 'numeric', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit', second: '2-digit' }).format(new Date(documentData.data.document.createdAt))} className="form-control disabled" placeholder="Document name" required readOnly />
                              <div className="">{form.errors?.name?.message}</div>
                            </div>
                          ...
                          <div className="col-sm-6">
                            <label htmlFor="firstName" className="form-label">Status de l'acte</label><div className="input-group has-validation">
                              <span className="input-group-text"><i className="bi bi-calendar"></i></span>
                              <input type="text" {...register('createdAt')} defaultValue={new Intl.DateTimeFormat('fr-fr', { weekday: 'long', year: 'numeric', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit', second: '2-digit' }).format(new Date(documentData.data.document.createdAt))} className="form-control enabled" placeholder="Document name" required readOnly />
                              <div className="">{form.errors?.name?.message}</div>
                            </div>
                          </div>
                          <div className="col-sm-6">
