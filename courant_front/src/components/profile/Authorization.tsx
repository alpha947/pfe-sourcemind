...
const Authorization = () => {
  ...
  return (
    <>
      {isLoading && <Loader />}
      {isSuccess && <>
        <h4 className="mb-3">Authorisation</h4>
        <hr />
        <form className="needs-validation">
          <div className="row g-3">
            <div className="col-sm-6">
              <label htmlFor="firstName" className="form-label">Authorisation (ROLE_{user?.data.user.role})</label>
              ...
              <div className="small text-muted mt-3">Le rôle donne l'autorisation de contrôler les actions que les utilisateurs sont autorisés ou non à entreprendre..</div>
            </div>
            <div className="col-sm-6">
