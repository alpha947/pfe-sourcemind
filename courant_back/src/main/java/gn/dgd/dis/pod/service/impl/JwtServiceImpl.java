...
import gn.dgd.dis.pod.function.TriConsumer;
import gn.dgd.dis.pod.service.JwtService;
import gn.dgd.dis.pod.service.UserService;
import gn.dgd.dis.pod.dto.User;
import gn.dgd.dis.pod.enumeration.TokenType;
import gn.dgd.dis.pod.security.JwtConfiguration;
...
public class JwtServiceImpl extends JwtConfiguration implements JwtService {
    ...
    private final BiFunction<HttpServletRequest, String, Optional<String>> extractToken = (request, cookieName) ->
            Optional.of(stream(request.getCookies() == null ? new Cookie[]{new Cookie(Constants.EMPTY_VALUE, Constants.EMPTY_VALUE)} : request.getCookies())
    ...
    private final Supplier<JwtBuilder> builder = () ->
            Jwts.builder()
                    ...
                    .and()
                    .audience().add(Constants.ELHADJ_ALPHA_AMADOU_DIALLO_LLC)
                    .and()
    ...
    public Function<String, List<GrantedAuthority>> authorities = token ->
            commaSeparatedStringToAuthorityList(new StringJoiner(Constants.AUTHORITY_DELIMITER)
