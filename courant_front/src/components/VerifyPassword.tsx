                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="d-flex align-items-center">
                                    {!error && <><strong role="status">Veuillez patienter. Verification...</strong>
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-6 col-md-6 col-sm-12" style={{ marginTop: '150px' }}>
                        <div className="card">
                            <div className="card-body">
                                <h4 className="mb-3">Entrer votre mot de passe</h4>
                                {resetError && <div className="alert alert-dismissible alert-danger">
                                    {'data' in resetError ? (resetError.data as IResponse<void>).message! : 'Une erreur s\'est produite'}
                                </div>}
                                ...
                                <form onSubmit={handleSubmit(handleResetPassword)} className="needs-validation" noValidate>
                                    ...
                                    <div className="row g-3">
                                        <div className="col-12">
                                            <label htmlFor="qrCode" className="form-label">Nouveau mot de passe</label>
                                        ...
                                        <div className="col-12">
                                            <label htmlFor="qrCode" className="form-label">Confirmer le nouveau mot de passe</label>
                                            <div className="input-group has-validation">
                                                <span className="input-group-text"><i className="bi bi-key"></i></span>
