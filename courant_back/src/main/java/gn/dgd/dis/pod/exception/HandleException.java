...
public class HandleException extends ResponseEntityExceptionHandler implements ErrorController {
    ...
    public ResponseEntity<Response> sQLIntegrityConstraintViolationException(SQLIntegrityConstraintViolationException exception) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse(exception.getMessage().contains("Duplicate entry") ? "Ces informations existent deja" : exception.getMessage(), getRootCauseMessage(exception), request, BAD_REQUEST), BAD_REQUEST);
    }
    ...
    public ResponseEntity<Response> disabledException(DisabledException exception) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse("Le compte de l'utilisateur est actuellement desactivé", getRootCauseMessage(exception), request, BAD_REQUEST), BAD_REQUEST);
    }
