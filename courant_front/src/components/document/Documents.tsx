          ...
          <div className="align-items-center row">
            <div className="col-lg-4">
              <div className="mb-3 mb-lg-0">
                ...
                <h6 className="fs-16 mb-0">{`${(documentData?.data?.documents.number * documentData?.data?.documents.size) + 1} - ${((documentData?.data?.documents.number * documentData?.data?.documents.size)) + documentData?.data.documents.content?.length} sur ${documentData?.data?.documents.totalElements}`}</h6>}
              </div>
            </div>
