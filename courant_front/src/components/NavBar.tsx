        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              {/* Menu du documents brute */}
              <li className="nav-item">
                <NavLink to='/documents' end className="nav-link" aria-current="page" title="Actes reglementaire de l'administration">Actes</NavLink>
              </li>
  
              {/* Le menu utilisateur qui depends du  */}
              {user?.data.user.role !== 'USER' && 
              <li className="nav-item">
                <NavLink to='/users' end className="nav-link">Utilisateurs</NavLink>
              </li>}
            </ul>
